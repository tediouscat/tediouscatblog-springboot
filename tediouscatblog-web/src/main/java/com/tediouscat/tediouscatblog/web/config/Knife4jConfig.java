package com.tediouscat.tediouscatblog.web.config;
...
public class Knife4jConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.tediouscat.tediouscatblog.web.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                .title("Tediouscatblog 博客前台接口文档") // 标题
